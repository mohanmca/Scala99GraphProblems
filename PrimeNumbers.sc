...
object PrimeNumbersTest {
  ...
  PrimeNumbers.goldbach(26)                       //> res0: List[List[Int]] = List(List(3, 23), List(7, 19))
  PrimeNumbers.printGoldbachList(9 to 20)         //> List(3, 7)List(5, 7)List(3, 11)List(3, 13)List(5, 11)List(5, 13)List(7, 11)L
                                                  //| ist(3, 17)List(7, 13)
                                                  //| res1: scala.collection.immutable.Seq[List[Int]] = Vector(List(3, 7), List(5,
                                                  //|  7), List(3, 11), List(3, 13), List(5, 11), List(5, 13), List(7, 11), List(3
                                                  //| , 17), List(7, 13))
